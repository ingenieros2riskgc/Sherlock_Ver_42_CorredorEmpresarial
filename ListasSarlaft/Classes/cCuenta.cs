    ...
    public class cCuenta : cPropiedades
    {
        ...
        public DataTable autenticarUsuarioAnt(string Usuario, string Contrasena)
        {
            ...
            try
            {
                ...
                strConsulta = string.Format("SELECT LTRIM(RTRIM(ISNULL(LU.Nombres,''))) + ' ' + LTRIM(RTRIM(ISNULL(LU.Apellidos,''))) AS NombreUsuario, LU.IdUsuario, " +"\n"+
                    ...
                    " LU.FechaUltActualPassword,djo.IdArea FROM Listas.Usuarios LU INNER JOIN Listas.Roles LR ON LU.IdRol = LR.IdRol " + "\n" +//,ar.NombreArea,djo.IdArea
        ...
        public String permisosConsulta(String IdFormulario)
        {
            ...
            try
            {
                ...
                {*/
                string query = "SELECT Consultar FROM Listas.Permisos WHERE (IdRol = " + IdRol + ") AND (IdFormulario = " + IdFormulario + ")";
                    cDataBase.conectar();
