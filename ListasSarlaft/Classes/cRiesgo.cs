    ...
    public class cRiesgo : cPropiedades
    {
        ...
        public DataTable mtdLoadEmpresa(bool booEstado)
        {
            ...
            try
            {
                ...
                strConsulta = string.Format("SELECT idHijo AS IdEmpresa, NombreHijo AS Descripcion FROM [Parametrizacion].[JerarquiaOrganizacional] WHERE idHijo = 1 and idPadre = -1");
                cDataBase.conectar();
                dtInformacion = cDataBase.ejecutarConsulta(strConsulta);
                cDataBase.desconectar();
            }
        ...
        public DataTable CargaDatosLeyenda()
        {
            ...
            {
                //strConsulta = string.Format("SELECT Riesgos.ControlesRiesgo.IdControlesRiesgo, Riesgos.Control.IdControl, Riesgos.Control.CodigoControl, Riesgos.Control.NombreControl, Parametrizacion.Test.NombreTest, ((((Parametrizacion.ClaseControl.ValorClaseControl) * (SELECT ValorPorcentajeCalificarControl FROM Parametrizacion.PorcentajeCalificarControl WHERE (IdPorcentajeCalificarControl = 1))) + ((Parametrizacion.TipoControl.ValorTipoControl) * (SELECT ValorPorcentajeCalificarControl FROM Parametrizacion.PorcentajeCalificarControl WHERE (IdPorcentajeCalificarControl = 2))) + ((Parametrizacion.ResponsableExperiencia.ValorResponsableExperiencia) * (SELECT ValorPorcentajeCalificarControl FROM Parametrizacion.PorcentajeCalificarControl WHERE (IdPorcentajeCalificarControl = 3))) + ((Parametrizacion.Documentacion.ValorDocumentacion) * (SELECT ValorPorcentajeCalificarControl FROM Parametrizacion.PorcentajeCalificarControl WHERE (IdPorcentajeCalificarControl = 4))) + ((Parametrizacion.Responsabilidad.ValorResponsabilidad) * (SELECT ValorPorcentajeCalificarControl FROM Parametrizacion.PorcentajeCalificarControl WHERE (IdPorcentajeCalificarControl = 5)))) / 100) AS CalificacionControl, Parametrizacion.CalificacionControl.DesviacionProbabilidad, Parametrizacion.CalificacionControl.DesviacionImpacto, Riesgos.Control.IdMitiga, Riesgos.Control.IdCalificacionControl, Parametrizacion.CalificacionControl.Color, Parametrizacion.CalificacionControl.NombreEscala FROM Riesgos.Control INNER JOIN Parametrizacion.ClaseControl ON Riesgos.Control.IdClaseControl = Parametrizacion.ClaseControl.IdClaseControl INNER JOIN Parametrizacion.TipoControl ON Riesgos.Control.IdTipoControl = Parametrizacion.TipoControl.IdTipoControl INNER JOIN Parametrizacion.ResponsableExperiencia ON Riesgos.Control.IdResponsableExperiencia = Parametrizacion.ResponsableExperiencia.IdResponsableExperiencia INNER JOIN Parametrizacion.Documentacion ON Riesgos.Control.IdDocumentacion = Parametrizacion.Documentacion.IdDocumentacion INNER JOIN Parametrizacion.Responsabilidad ON Riesgos.Control.IdResponsabilidad = Parametrizacion.Responsabilidad.IdResponsabilidad INNER JOIN Riesgos.ControlesRiesgo ON Riesgos.Control.IdControl = Riesgos.ControlesRiesgo.IdControl INNER JOIN Parametrizacion.Test ON Riesgos.Control.IdTest = Parametrizacion.Test.IdTest INNER JOIN Parametrizacion.CalificacionControl ON Riesgos.Control.IdCalificacionControl = Parametrizacion.CalificacionControl.IdCalificacionControl WHERE (Riesgos.ControlesRiesgo.IdRiesgo = {0})", IdRiesgo);
                strConsulta = string.Format("SELECT IdClasificacionRiesgo, NombreClasificacionRiesgo  FROM Parametrizacion.ClasificacionRiesgo ");//, color
                cDataBase.conectar();
                dtInformacion = cDataBase.ejecutarConsulta(strConsulta);
                cDataBase.desconectar();
            }
        ...
        {//consulta busca evento de riesgo
            ...
            try
            {
                ...
                cDataBase.conectar();
                string query = string.Format("SELECT Riesgos.Riesgo.IdRiesgo, Riesgos.Riesgo.IdRegion, Riesgos.Riesgo.IdPais, Riesgos.Riesgo.IdDepartamento, Riesgos.Riesgo.IdCiudad,"+"\n"+
                    " Riesgos.Riesgo.IdOficinaSucursal, Riesgos.Riesgo.IdCadenaValor, Riesgos.Riesgo.IdMacroproceso, Riesgos.Riesgo.IdProceso, Riesgos.Riesgo.IdSubProceso, Riesgos.Riesgo.IdActividad," + "\n" +
                    " Riesgos.Riesgo.IdClasificacionRiesgo, Riesgos.Riesgo.IdClasificacionGeneralRiesgo, Riesgos.Riesgo.IdClasificacionParticularRiesgo, Riesgos.Riesgo.IdFactorRiesgoOperativo," + "\n" +
                    " Riesgos.Riesgo.IdTipoRiesgoOperativo, Riesgos.Riesgo.IdTipoEventoOperativo, Riesgos.Riesgo.IdRiesgoAsociadoOperativo, Riesgos.Riesgo.ListaRiesgoAsociadoLA, Riesgos.Riesgo.ListaFactorRiesgoLAFT, " + "\n" +
                    "Riesgos.Riesgo.Codigo, Riesgos.Riesgo.Nombre, Riesgos.Riesgo.Descripcion, Riesgos.Riesgo.ListaCausas, Riesgos.Riesgo.ListaConsecuencias, Riesgos.Riesgo.IdResponsableRiesgo, " + "\n" +
                    "Riesgos.Riesgo.IdProbabilidad, Riesgos.Riesgo.OcurrenciaEventoDesde, Riesgos.Riesgo.OcurrenciaEventoHasta, Riesgos.Riesgo.IdImpacto, Riesgos.Riesgo.PerdidaEconomicaDesde, " + "\n" +
                    "Riesgos.Riesgo.PerdidaEconomicaHasta, Riesgos.Riesgo.FechaRegistro, LTRIM(RTRIM(Listas.Usuarios.Nombres)) + ' ' + LTRIM(RTRIM(Listas.Usuarios.Apellidos)) AS Nombres, " + "\n" +
                    "Parametrizacion.ClasificacionRiesgo.NombreClasificacionRiesgo, Parametrizacion.JerarquiaOrganizacional.NombreHijo, Riesgos.Riesgo.ListaTratamiento,Riesgos.Riesgo.idResponsableTratamiento,  " + "\n" +//
                    " Riesgos.Riesgo.Estado, Riesgos.Riesgo.TipoMedicion " + "\n" +//
                    "FROM Riesgos.Riesgo " + "\n" +
                    ...
                    "WHERE (Riesgos.Riesgo.Anulado = 0) {0}"
                    , condicion);
            ...
            try
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        strConsulta = string.Format("{0} {1} GROUP BY RR.IdClasificacionRiesgo, CR.NombreClasificacionRiesgo", strSelNormal, strFromNormal);//, CR.Color
                    }
                    #endregion Filtros por Objetivos Estrategicos
                    #endregion Filtros Normales
                }
                ...
                switch (numeroQuery)
                {
                    case "1":
                        ...
                        strSelect = "SELECT LTRIM(RTRIM(RR.Codigo)) CodigoRiesgo, LTRIM(RTRIM(LU.Nombres)) + ' ' + LTRIM(RTRIM(LU.Apellidos)) Usuario, LTRIM(RTRIM(RR.Nombre)) NombreRiesgo,"+"\n"+
                            "LTRIM(RTRIM(RR.Descripcion)) DescripcionRiesgo, PJO.NombreHijo ResponsableRiesgo, LTRIM(RTRIM(ISNULL(CONVERT(VARCHAR, RR.FechaRegistro, 107), ''))) FechaRegistroRiesgo, " + "\n" +
                            "LTRIM(RTRIM(ISNULL(PCR.NombreClasificacionRiesgo, ''))) ClasificacionRiesgo, LTRIM(RTRIM(ISNULL(PCGR.NombreClasificacionGeneralRiesgo, ''))) ClasificacionGeneralRiesgo, " + "\n" +
                            "LTRIM(RTRIM(ISNULL(PCPR.NombreClasificacionParticularRiesgo, ''))) ClasificacionParticularRiesgo, LTRIM(RTRIM(ISNULL(PTEO.NombreTipoEventoOperativo, ''))) TipoEvento, " + "\n" +
                            "LTRIM(RTRIM(ISNULL([Procesos].[FnDescriptionListCausas](RR.ListaCausas, '|'), ''))) Causas, LTRIM(RTRIM(ISNULL([Procesos].[FnDescriptionListConsecuencias](RR.ListaConsecuencias, '|'), ''))) Consecuencias, " + "\n" +
                            "LTRIM(RTRIM(ISNULL(PCV.NombreCadenaValor, ''))) CadenaValor, LTRIM(RTRIM(ISNULL(PM.Nombre, ''))) Macroproceso, LTRIM(RTRIM(ISNULL(PP.Nombre, ''))) Proceso, LTRIM(RTRIM(ISNULL(PS.Nombre, ''))) Subproceso," + "\n" +
                            " LTRIM(RTRIM(ISNULL(PA.Nombre, ''))) Actividad, LTRIM(RTRIM(ISNULL([Procesos].[FnDescriptionListTreatment](RR.ListaTratamiento, '|'), ''))) ListaTratamiento, LTRIM(RTRIM(ISNULL(PPr.NombreProbabilidad, ''))) FrecuenciaInherente," + "\n" +
                            " LTRIM(RTRIM(ISNULL(PPr.ValorProbabilidad, ''))) CodigoFrecuenciaInherente, LTRIM(RTRIM(ISNULL(PIm.NombreImpacto, ''))) ImpactoInherente, LTRIM(RTRIM(ISNULL(PIm.ValorImpacto, ''))) CodigoImpactoInherente, " + "\n" +
                            "LTRIM(RTRIM(ISNULL(PRI.NombreRiesgoInherente, ''))) RiesgoInherente, LTRIM(RTRIM(ISNULL(PRI.ValorRiesgoInherente, ''))) CodigoRiesgoInherente, LTRIM(RTRIM(ISNULL(pr.NombreProbabilidad, ''))) FrecuenciaResidual, LTRIM(RTRIM(ISNULL(pr.ValorProbabilidad, ''))) CodigoFrecuenciaResidual, " + "\n" +
                            "LTRIM(RTRIM(ISNULL(im.NombreImpacto, ''))) ImpactoResidual, LTRIM(RTRIM(ISNULL(im.ValorImpacto, ''))) CodigoImpactoResidual, LTRIM(RTRIM(ISNULL(RiesgoResidual.NombreRiesgoInherente, ''))) RiesgoResidual, LTRIM(RTRIM(ISNULL(RiesgoResidual.ValorRiesgoInherente, ''))) CodigoRiesgoResidual," + "\n" +
                            "LTRIM(RTRIM(ISNULL(PFRO.NombreFactorRiesgoOperativo, ''))) FactorRiesgoOperativo, LTRIM(RTRIM(ISNULL(PRAO.NombreRiesgoAsociadoOperativo, ''))) RiesgoAsociadoOperativo, LTRIM(RTRIM(ISNULL(PTRO.NombreTipoRiesgoOperativo, ''))) SubFactorRiesgoOperativo," + "\n" +
                            " LTRIM(RTRIM(ISNULL([Procesos].[FnDescriptionList](RR.LISTARIESGOASOCIADOLA, '|'), ''))) ListaRiesgoAsociadoLA, LTRIM(RTRIM(ISNULL([Procesos].[FnDescriptionListLAFT](RR.LISTAFACTORRIESGOLAFT, '|'), ''))) ListaFactorRiesgoLAFT," + "\n" +
                            " 'Region:' + LTRIM(RTRIM(ISNULL(PReg.NombreRegion, ''))) + ' - Pais:' + LTRIM(RTRIM(ISNULL(PPai.NombrePais, ''))) + ' - Depto:' + LTRIM(RTRIM(ISNULL([NombreDepartamento], ''))) + ' - Ciudad:' + LTRIM(RTRIM(ISNULL([NombreCiudad], ''))) + ' - Of:' + LTRIM(RTRIM(ISNULL([NombreOficinaSucursal], ''))) Ubicacion," + "\n" +
                            "Parea.NombreArea,  RR.IdRiesgo, ISNULL(RR.TipoMedicion,0) as TipoMedicion";//PER.NombreEstado 'EstadoRiesgo'
                    ...
                    case "3":
                        ...
                        strSelect = "SELECT LTRIM(RTRIM(RR.Codigo)) CodigoRiesgo, LTRIM(RTRIM(LU.Nombres)) + ' ' + LTRIM(RTRIM(LU.Apellidos)) Usuario, "  + "\n" +
                            ...
                            "LTRIM(RTRIM(ISNULL(PPr.NombreProbabilidad, ''))) FrecuenciaInherente, LTRIM(RTRIM(ISNULL(PPr.ValorProbabilidad, ''))) CodigoFrecuenciaInherente, "+ "\n" + 
                            "LTRIM(RTRIM(ISNULL(PIm.NombreImpacto, ''))) ImpactoInherente, LTRIM(RTRIM(ISNULL(PIm.ValorImpacto, ''))) CodigoImpactoInherente, LTRIM(RTRIM(ISNULL(PRI.NombreRiesgoInherente, ''))) RiesgoInherente, "+ "\n" + 
                            "LTRIM(RTRIM(ISNULL(PRI.ValorRiesgoInherente, ''))) CodigoRiesgoInherente, LTRIM(RTRIM(ISNULL(PR.NombreProbabilidad, ''))) FrecuenciaResidual, LTRIM(RTRIM(ISNULL(PR.ValorProbabilidad, ''))) CodigoFrecuenciaResidual,"+ "\n" + 
                            " LTRIM(RTRIM(ISNULL(IM.NombreImpacto, ''))) ImpactoResidual, LTRIM(RTRIM(ISNULL(im.ValorImpacto, ''))) CodigoImpactoResidual, LTRIM(RTRIM(ISNULL(RiesgoResidual.NombreRiesgoInherente, ''))) RiesgoResidual, "+ "\n" + 
                            "LTRIM(RTRIM(ISNULL(RiesgoResidual.ValorRiesgoInherente, ''))) CodigoRiesgoResidual, LTRIM(RTRIM(ISNULL(RE.CodigoEvento, ''))) CodigoEvento, LTRIM(RTRIM(ISNULL(RE.DescripcionEvento, ''))) DescripcionEvento, ResponsableEvento.NombreHijo ResponsableEvento, "+ "\n" + 
                            ...
                            "LTRIM(RTRIM(ISNULL(RE.ValorRecuperadoSeguro, ''))) ValorRecuperadoSeguro, LTRIM(RTRIM(ISNULL(RE.Observaciones, ''))) Observaciones, LTRIM(RTRIM(ISNULL(PDpto.NombreDepartamento, ''))) NombreDepartamento, LTRIM(RTRIM(ISNULL(PCiu.NombreCiudad, ''))) NombreCiudad,"+ "\n" + 
                            " LTRIM(RTRIM(ISNULL(POS.NombreOficinaSucursal, ''))) NombreOficinaSucursal, LTRIM(RTRIM(ISNULL(PCE.NombreClaseEvento, ''))) NombreClaseEvento, LTRIM(RTRIM(ISNULL(PTPE.NombreTipoPerdidaEvento, ''))) NombreTipoPerdidaEvento, LTRIM(RTRIM(ISNULL(PFRO.NombreFactorRiesgoOperativo, ''))) FactorRiesgoOperativo, "+ "\n" + 
                            "LTRIM(RTRIM(ISNULL(PRAO.NombreRiesgoAsociadoOperativo, ''))) RiesgoAsociadoOperativo, LTRIM(RTRIM(ISNULL(PTRO.NombreTipoRiesgoOperativo, ''))) SubFactorRiesgoOperativo, LTRIM(RTRIM(ISNULL([Procesos].[FnDescriptionList](RR.LISTARIESGOASOCIADOLA, '|'), ''))) ListaRiesgoAsociadoLA,"+ "\n" + 
        ...
        public DataTable ConsultaPlanesAsociados(string CodigoRiesgo)
        {
            ...
            {
                cDataBase.conectar();
                string query = "SELECT PlanesRiesgosAsociados.CodigoPlan, \n"
            ...
            )
        {
            ...
            try
            {
                ...
                string strSelect = "SELECT LTRIM(RTRIM(ISNULL(RCtrl.CodigoControl, ''))) AS CodigoControl, LTRIM(RTRIM(ISNULL(RCtrl.NombreControl, ''))) AS NombreControl,LTRIM(RTRIM(ISNULL(RCtrl.ResponsableEjecucion, ''))) as ResponsableEjecucion,"+"\n"+
                    " ResponsableControl.NombreHijo AS ResponsableCalificacion, LTRIM(RTRIM(ISNULL(CONVERT(varchar, RCtrl.FechaRegistro, 107), ''))) AS FechaRegistroControl, LTRIM(RTRIM(ISNULL(PPer.NombrePeriodicidad, ''))) AS NombrePeriodicidad, " + "\n" +
                    "LTRIM(RTRIM(ISNULL(PT.NombreTest, ''))) AS NombreTest, LTRIM(RTRIM(ISNULL(PCC.NombreClaseControl, ''))) AS NombreClaseControl, LTRIM(RTRIM(ISNULL(PTC.NombreTipoControl, ''))) AS NombreTipoControl," + "\n" +
                    " LTRIM(RTRIM(ISNULL(PRE.NombreResponsableExperiencia, ''))) AS NombreResponsableExperiencia, LTRIM(RTRIM(ISNULL(PD.NombreDocumentacion, ''))) AS NombreDocumentacion, LTRIM(RTRIM(ISNULL(PRes.NombreResponsabilidad, ''))) AS NombreResponsabilidad," + "\n" +
                    "RCV.NombreVariable,RCV.NombreCategoria, LTRIM(RTRIM(ISNULL(PCCtrl.NombreEscala, ''))) AS NombreEscala, LTRIM(RTRIM(ISNULL(PMCtrl.NombreMitiga, ''))) AS NombreMitiga, (CASE WHEN PMCtrl.IdMitiga = 1 THEN '' ELSE LTRIM(RTRIM(ISNULL(PCCtrl.DesviacionImpacto, '')))END) AS DesviacionImpacto," + "\n" + 
                    " (CASE WHEN PMCtrl.IdMitiga = 2 THEN '' ELSE LTRIM(RTRIM(ISNULL(PCCtrl.DesviacionProbabilidad, ''))) END) AS DesviacionFrecuencia, LTRIM(RTRIM(ISNULL(RCtrl.DescripcionControl, ''))) AS DescripcionControl, LTRIM(RTRIM(ISNULL(RCtrl.ObjetivoControl, ''))) AS ObjetivoControl";
                ...
                string strFrom = "FROM Riesgos.Control AS RCtrl " + "\n" +
                    ...
                    "LEFT JOIN Parametrizacion.ClaseControl AS PCC ON PCC.IdClaseControl = RCtrl.IdClaseControl " + "\n" +
                    "LEFT JOIN Parametrizacion.TipoControl AS PTC ON PTC.IdTipoControl = RCtrl.IdTipoControl" + "\n" +
                    " LEFT JOIN Parametrizacion.ResponsableExperiencia AS PRE ON PRE.IdResponsableExperiencia = RCtrl.IdResponsableExperiencia " + "\n" +
                    "LEFT JOIN Parametrizacion.Documentacion AS PD ON PD.IdDocumentacion = RCtrl.IdDocumentacion " + "\n" +
                    "LEFT JOIN Parametrizacion.Responsabilidad AS PRes ON PRes.IdResponsabilidad = RCtrl.IdResponsabilidad " + "\n" +
                    "left join Riesgos.ControlxVariable as RCV on RCV.IdControl = RCtrl.IdControl " + "\n" +
