    ...
    public class cControl : cPropiedades
    {
        ...
        public DataTable loadInfoControles(String CodigoControl, String NombreControl, String Responsable)
        {
            ...
            try
            {
                ...
                cDataBase.conectar();
                string query = string.Format("SELECT Riesgos.Control.IdControl, Riesgos.Control.CodigoControl, Riesgos.Control.NombreControl, Riesgos.Control.DescripcionControl,"+"\n"+
                    " Riesgos.Control.ObjetivoControl, Riesgos.Control.Responsable, Riesgos.Control.IdPeriodicidad, Riesgos.Control.IdTest, Parametrizacion.Test.NombreTest, Riesgos.Control.IdClaseControl" + "\n" +
                    ", Riesgos.Control.IdTipoControl, Riesgos.Control.IdResponsableExperiencia, Riesgos.Control.IdDocumentacion, Riesgos.Control.IdResponsabilidad, Riesgos.Control.IdCalificacionControl, " + "\n" +
                    "Riesgos.Control.FechaRegistro, Riesgos.Control.IdUsuario, Riesgos.Control.IdMitiga, Parametrizacion.JerarquiaOrganizacional.NombreHijo,Riesgos.Control.ResponsableEjecucion, Riesgos.control.Estado " + "\n" +
        ...
        public DataTable loadInfoControlesByRiesgo(String idRiesgo)
        {
            DataTable dtInformacion = new DataTable();
            String condicion = "";
            try
            {
                condicion = "where [Riesgos].[ControlesRiesgo].IdRiesgo = "+idRiesgo;
                cDataBase.conectar();
                string query = string.Format("SELECT Riesgos.Control.IdControl, Riesgos.Control.CodigoControl, Riesgos.Control.NombreControl, Riesgos.Control.DescripcionControl," + "\n" +
                    " Riesgos.Control.ObjetivoControl, Riesgos.Control.Responsable, Riesgos.Control.IdPeriodicidad, Riesgos.Control.IdTest, Parametrizacion.Test.NombreTest, Riesgos.Control.IdClaseControl" + "\n" +
                    ", Riesgos.Control.IdTipoControl, Riesgos.Control.IdResponsableExperiencia, Riesgos.Control.IdDocumentacion, Riesgos.Control.IdResponsabilidad, Riesgos.Control.IdCalificacionControl, " + "\n" +
                    "Riesgos.Control.FechaRegistro, Riesgos.Control.IdUsuario, Riesgos.Control.IdMitiga, Parametrizacion.JerarquiaOrganizacional.NombreHijo,Riesgos.Control.ResponsableEjecucion, Riesgos.control.Estado " + "\n" +
                    "FROM Riesgos.Control " + "\n" +
                    "INNER JOIN [Riesgos].[ControlesRiesgo] on [Riesgos].[ControlesRiesgo].IdControl = Riesgos.Control.IdControl "+"\n"+
                    "INNER JOIN Parametrizacion.Test ON Riesgos.Control.IdTest = Parametrizacion.Test.IdTest " + "\n" +
                    "LEFT JOIN Parametrizacion.JerarquiaOrganizacional ON Parametrizacion.JerarquiaOrganizacional.idHijo = Riesgos.Control.Responsable " + "\n" +
                    "{0}", condicion);
                dtInformacion = cDataBase.ejecutarConsulta(query);
