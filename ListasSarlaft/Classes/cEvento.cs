            ...
            string FechaContabilidad, string HoraContabilidad, string IdEvento)
        {
            try
            {
                ...
                string query = "UPDATE Riesgos.Eventos SET IdCadenaValor='" + cadenaValor + "',IdMacroproceso='" + macroProceso +
                    "',IdProceso='" + proceso + "',IdSubProceso='" + subproceso + "',IdActividad='" + actividad + "',IdClase='" + IdClase + "',IdSubClase='" + IdSubClase +
                    "',IdTipoPerdidaEvento='" + IdTipoPerdidaEvento + "',IdLineaProceso='" + IdLineaProceso + "',IdSubLineaProceso='" + IdSubLineaProceso + "',AfectaContinudad='" + AfectaContinudad +
                    "',IdEstado='" + IdEstado + "',Observaciones='" + Observaciones + "',CuentaPUC='" + CuentaPUC + "',CuentaOrden='" + CuentaOrden + "',TasaCambio1='" + TasaCambio1 + "',ValorPesos1='" + ValorPesos1 +
                    "',ValorRecuperadoTotal='" + ValorRecuperadoTotal + "',Moneda2='" + Moneda2 + "',TasaCambio2='" + TasaCambio2 + "',ValorPesos2='" + ValorPesos2 + "',Recuperacion='" + Recuperacion +
