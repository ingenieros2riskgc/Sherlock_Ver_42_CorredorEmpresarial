    ...
    public partial class Auuditoriaa : System.Web.UI.UserControl
    {
        ...
        protected void GridView7_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (GridView7.SelectedRow.RowType == DataControlRowType.DataRow)
            {
                ...
                if (GridView7.SelectedDataKey[1].ToString() == "34")
                    rblAudCondicion.SelectedValue = "2";
                else
                    rblAudCondicion.SelectedValue = "1";
...
objReau.intPeriodicidad.ToString().Trim()
        ...
        protected void btnImgCancelar_Click(object sender, ImageClickEventArgs e)
        {
            ...
            string strErrMsg = string.Empty;
            int IdArea = Convert.ToInt32(Session["IdAreaUser"].ToString());
            gvRiegosAud.DataSource = null;
            gvRiegosAud.DataBind();
            gvControlesRiesgosAud.DataSource = null;
            ...
            if (err == false)
            {
                ...
                if (VerificarCampos())
                {
                    ...
                    if (!err )
                    {
                        ...
                        gvAsociaciones.DataSource = null;
                        gvAsociaciones.DataBind();
                        gvAsocAct.DataSource = null;
                        gvAsocAct.DataBind();
                        txtControlAct.Text = string.Empty;
        ...
        protected void btnTemasAud_Click(object sender, EventArgs e)
        {
            ...
            ddlEspecial.SelectedIndex = 0;
            cblSemanaExe.ClearSelection();
            txtCodAuditoriaGen.Text = string.Empty;
        }
        ...
        protected void ImageButton11_Click(object sender, ImageClickEventArgs e)
        {
                ...
                mtdRegistrarAudObjRecurso(txtCodObjetivo.Text.Trim());
            }
            else
            {
        ...
        public void mtdRegistrarAudObjRecurso(string IdObjetivo)
        {
            ...
            cAu.InsertarRecursosGruposAuditoria(Sanitizer.GetSafeHtmlFragment(txtCodAuditoriaGen.Text.Trim()), ddlObjetivoAud.SelectedValue,//DtInfo.Rows[0]["IdObjetivo"].ToString().Trim()
        ...
        protected void ImgBNewRegistro_Click(object sender, ImageClickEventArgs e)
        {
            ...
            else
            {
                if (txtCodPlaneacion.Text != "0")
                {
                    ...
                    ddlObjetivoAud.Items.Clear();
                    ddlObjetivoAud.DataBind();
                    GridView3.DataBind();
                    GridView2.DataBind();
                    GridView12.DataBind();
                    ddlGrupoAud2.Enabled = true;
        ...
        protected void GVregistrosAuditoria_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (GVregistrosAuditoria.SelectedRow.RowType == DataControlRowType.DataRow)
            {
                if(Session["mod"] != null && Session["mod"].ToString() == "1")
                {
                    ...
                    if (GVregistrosAuditoria.SelectedDataKey[1].ToString().Trim() == "34")
                        rblAudCondicion.SelectedValue = "2";
                    else
                        rblAudCondicion.SelectedValue = "1";
                    lblEstandar.Text = GVregistrosAuditoria.SelectedDataKey[1].ToString().Trim();
        ...
        public void mtdValidaTipoAud()
        {
            if (rblAudCondicion.SelectedValue == "1")
            {
                ddlEstandar.SelectedIndex = 0;
                ddlObjetivo.DataBind();
                trRiesgosAud.Visible = false;
                trActivadesControl.Visible = false;
                trAsociaciones.Visible = false;
            ...
            switch (e.CommandName)
            {
                case "select":
                    ...
                    try
                    {
                        ...
                        loadGridControles();
                        loadInfoControles(colsNoVisible[0].ToString());
        ...
        private void loadInfoControles(string idRiesgo)
        {
            DataTable dtInfo = new DataTable();
            cControl cControl = new cControl();
            //dtInfo = cControl.loadInfoControles("","","");
            if(idRiesgo != string.Empty)
            {
                dtInfo = cControl.loadInfoControlesByRiesgo(idRiesgo);
            }else
                dtInfo = cControl.loadInfoControles("", "", "");
        ...
        protected void gvAsociaciones_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (gvAsociaciones.SelectedRow.RowType == DataControlRowType.DataRow)
            {
                ...
                Session["rowgvAsocAct"] = null;
            }
        }
        protected void gvAsocAct_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (gvAsocAct.SelectedRow.RowType == DataControlRowType.DataRow)
            {
                Session["rowgvAsocAct"] = gvAsocAct.SelectedRow.RowIndex;
                Session["rowAsociaciones"] = null;
            }
        }
        protected void btnImgokDelAsoc_Click(object sender, EventArgs e)
        {
            int Row = Session["rowAsociaciones"] != null ? Convert.ToInt32(Session["rowAsociaciones"].ToString())
                : Convert.ToInt32(Session["rowgvAsocAct"].ToString());
            if(Session["rowAsociaciones"] != null)
            {
            ...
            {
                InfoGridActControlesAdd.Rows[Row].Delete();
        ...
        {
            loadGridControles();
            loadInfoControles(string.Empty);
        }
        ...
        protected void imgRegresoRiesgosAct_Click(object sender, ImageClickEventArgs e)
        {
            ...
            loadGridControles();
            loadInfoControles(Session["IdRiesgo"].ToString());
            if (InfoGridRiesgosControlesAdd == null)
                createRiesgosControlesAdd();
            /*loadGridControles();
            loadInfoControles(string.Empty);*/
        ...
        private void loadInfoRecursos()
        {
            DataTable dtInfo = new DataTable();
            dtInfo = cAu.LoasRecursosPlaneacion(Sanitizer.GetSafeHtmlFragment(txtCodAuditoria.Text), Sanitizer.GetSafeHtmlFragment(ddlObjetivoAud.SelectedValue), ddlGrupoAud2.SelectedValue.ToString());
        ...
        protected void ddlObjetivoAud_SelectedIndexChanged(object sender, EventArgs e)
        {
            loadGrid();
            loadInfoRecursos();
        }

        protected void ddlObjetivoAud_DataBound(object sender, EventArgs e)
        {
            loadGrid();
            loadInfoRecursos();
        }
