...
<!--SELECT [IdPlaneacion], [Nombre] FROM [Auditoria].[Planeacion] where [IdArea] =-->
<!--inner JOIN  Auditoria.Auditoria as AA on AP.IdPlaneacion = AA.IdPlaneacion
INNER JOIN Procesos.Proceso as PP on PP.IdProceso = AA.IdProceso
where AP.[IdArea] = @IdArea  or PP.IdHijo = @IdProceso-->
<asp:SqlDataSource ID="SqlDataSource8" runat="server" ConnectionString="<%$ ConnectionStrings:SarlaftConnectionString %>"
    SelectCommand="SELECT AP.[IdPlaneacion], AP.[Nombre] FROM [Auditoria].[Planeacion] as AP">
    <SelectParameters>
        <asp:Parameter Name="IdArea" Type="Int32" />
    </SelectParameters>
    <SelectParameters>
...
<asp:SqlDataSource ID="SqlDataSource24" runat="server" ConnectionString="<%$ ConnectionStrings:SarlaftConnectionString %>"
    SelectCommand="SELECT R.IdRecomendacion,  CONVERT(VARCHAR(MAX), R.Observacion) AS Recomendacion, R.Estado, O.Nombre, R.Tipo, J.NombreHijo AS Nombre_DP, CONVERT(VARCHAR(10), R.[FechaRegistro],120) AS FechaRegistro, R.edadRecomendacion,H.IdDetalleTipoHallazgo, DT.NombreDetalle as TipoHallazgo,H.IdNivelRiesgo, PDT.NombreDetalle as NivelRiesgo
                    FROM Auditoria.Recomendacion AS R, Auditoria.Hallazgo AS H, Auditoria.Auditoria AS A, Parametrizacion.JerarquiaOrganizacional AS J, Auditoria.DetalleEnfoque AS DE, Auditoria.Enfoque AS E, Auditoria.Objetivo AS O, Parametrizacion.DetalleTipos as DT, [Parametrizacion].[DetalleTipos] PDT
                    WHERE A.IdAuditoria = @IdAuditoria AND
						  ...
						  DT.IdDetalleTipo = H.IdDetalleTipoHallazgo
						  AND PDT.IdDetalleTipo = H.IdNivelRiesgo
                    UNION
                    SELECT R.IdRecomendacion, CONVERT(VARCHAR(MAX), R.Observacion) AS Recomendacion, R.Estado, O.Nombre, R.Tipo, P.Nombre AS Nombre_DP, CONVERT(VARCHAR(10), R.[FechaRegistro],120) AS FechaRegistro, R.edadRecomendacion,H.IdDetalleTipoHallazgo,  DT.NombreDetalle as TipoHallazgo,H.IdNivelRiesgo, PDT.NombreDetalle as NivelRiesgo
                    FROM Auditoria.Recomendacion AS R, Auditoria.Hallazgo AS H, Auditoria.Auditoria AS A, Procesos.Proceso AS P, Auditoria.DetalleEnfoque AS DE, Auditoria.Enfoque AS E, Auditoria.Objetivo AS O, Parametrizacion.DetalleTipos as DT, [Parametrizacion].[DetalleTipos] PDT
                    WHERE A.IdAuditoria = @IdAuditoria AND
	                      H.IdAuditoria = A.IdAuditoria AND
	                      R.IdHallazgo  = H.IdHallazgo AND
                          R.IdHallazgo = @IdHallazgo AND
            ...
            <tr visible="true">
                ...
                <ItemTemplate>
                    <asp:ImageButton ID="imgBtn1" CssClass="SelectRow" runat="server" CausesValidation="false"
                        CommandArgument='<%#Eval("IdAuditoria")%>'  CommandName="ViewFactors" ImageUrl="~/Imagenes/Icons/audit.png"
                        Text="" />
                </ItemTemplate>
            </asp:TemplateField>
                            </Columns>
                                                    ...
                                                    <td>
                                                        ...
                                                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:BoundField DataField="TipoHallazgo" HeaderText="Tipo de Hallazgo"
                                                                    SortExpression="TipoHallazgo" ReadOnly="True" HtmlEncode="False"
                                                                    HtmlEncodeFormatString="False">
                                                                    <ItemStyle HorizontalAlign="Left" />
                                                                </asp:BoundField>
                                                                <asp:BoundField DataField="NivelRiesgo" HeaderText="Nivel del Riesgo"
                                                                    SortExpression="NivelRiesgo" ReadOnly="True" HtmlEncode="False"
                                                                    HtmlEncodeFormatString="False">
                                                                    <ItemStyle HorizontalAlign="Left" />
                                                                </asp:BoundField>
                                                            </Columns>
