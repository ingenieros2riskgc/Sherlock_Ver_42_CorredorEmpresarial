...
<asp:SqlDataSource ID="sqlObjetivoAud" runat="server" ConnectionString="<%$ ConnectionStrings:SarlaftConnectionString %>"
    SelectCommand=" select Nombre, obj.IdObjetivo from  [Auditoria].[AuditoriaObjetivo] as audObje
inner join Auditoria.Objetivo as obj on obj.IdObjetivo = audObje.IdObjetivo
where audObje.IdAuditoria = @IdAuditoria
">
    <SelectParameters>
        <asp:ControlParameter ControlID="txtCodAuditoriaGen" Name="IdAuditoria" PropertyName="Text"
            Type="Int64" />
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
        ...
        <div id="TreeDIV" runat="server">
            ...
            <asp:Label ID="lblEstandar" runat="server" Text="xxx" Visible="false"></asp:Label>
        </div>
                            ...
                            <td>
                                <table>
                                    ...
                                    DataKeyNames="IdControl" 
                                                         OnSelectedIndexChanged="gvAsocAct_SelectedIndexChanged"   
                                     AllowPaging="True" >
                                    <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                                    <Columns>
                                        <asp:BoundField HeaderText="Código" DataField="CodigoControl" />
                                                ...
                                                <tr>
                                                    <td>
                                                        <table>
                                                            ...
                                                            <tr>
                                                                <td align="left" bgcolor="#BBBBBB">
                                                                    <asp:Label ID="Label84" runat="server" Text="Objetivo Auditoria:" Font-Names="Calibri"
                                                                        Font-Size="Small"></asp:Label>
                                                                </td>
                                                                <td>
                                                                    <table class="tablaSinBordes">
                                                                        <tr>
                                                                            <td>
                                                                                <asp:DropDownList ID="ddlObjetivoAud" runat="server" AutoPostBack="True" Font-Names="Calibri"
                                                                                    OnSelectedIndexChanged="ddlObjetivoAud_SelectedIndexChanged" Font-Size="Small" Width="400px" DataSourceID="sqlObjetivoAud"
                                                                                    OnDataBound="ddlObjetivoAud_DataBound"
                                                                                    DataTextField="Nombre" DataValueField="IdObjetivo">
                                                                                </asp:DropDownList>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
