...
" and AuditoriaProceso.IdTipoProceso = 1 and [Auditoria].IdArea ={2} {1}", IdPlaneacion, strCondicion, IdArea);
        ...
        protected void btnLoad_Click(object sender, EventArgs e)
        {
            ...
            if(ddlTipoAdjunto.SelectedValue == "3")
            {
                // Se carga la ruta física de la carpeta temp del sitio
                string ruta = Server.MapPath("~/ArchivosAdjuntos/PDF");
                ...
                {*/
                if (txtCodAuditoriaSel.Text == string.Empty)
                {
                    omb.ShowMessage("Se debe seleccionar una Auditoria", 2, "Atención");
                    return;
                }
                    
                if(txtCodHallazgo.Text == string.Empty)
                {
                    omb.ShowMessage("Se debe seleccionar un Hallazgo", 2, "Atención");
                    return;
                }
                ...
                try
                {
                    ...
                    {
                        omb.ShowMessage("Sólo se permiten para las tablas formatos PDF", 2, "Atención");
                    }
